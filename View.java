...
public class View extends JFrame{
    ...
    public View()
    {
        ...
        file=new JMenu("File");
        edit=new JMenu("Edit");
        aboutitem=new JMenuItem("Ó÷åôéêÜ...");
        instructions=new JMenuItem("Ïäçãßåò ãéá óùóôÞ ÷ñÞóç ôïõ ðñïãñÜììáôïò");
        exit=new JMenuItem ("¸îïäïò");
        aboutitem.addActionListener(
                new ActionListener()
                {
                    ...
                    {
                        JOptionPane.showMessageDialog(View.this,"Äçìéïõñãüò:Sotiris Karapostolakis\nAEM:2125\n¸ôïò:2013\nÅëðßæù íá ôï åõ÷áñéóôçèåßôå!!!","Ó÷åôéêÜ",JOptionPane.PLAIN_MESSAGE);
                    }
                });
        instructions.addActionListener(
                new ActionListener()
                {
                    ...
                    public void actionPerformed(ActionEvent event)
                    {
                        JOptionPane.showMessageDialog(View.this, "ÅðéëÝîåôå ðñþôá ôïí áñéèìü ôùí balander,ôï åßäïò ðáé÷íéäéïý\n êáé ôçí ìíÞìç ôïõ õðïëïãéóôÞ åÜí ðñüêåéôáé ãéá ðáé÷íßäé ìåôáîý áíèñþðïõ êáé õðïëïãéóôç.\nÓôç óõíÝ÷åéá ðáôÞóôå ôï ðëÞêôñï newgame.\nÓå êÜèå åðéëïãÞ åßôå áõôÞ áöïñÜ ðáßêôç åßôå áöïñÜ ôïí õðïëïãéóôÞ\nðñÝðåé íá ðáôÜôå ôï ðëÞêôñï confirm.","Ïäçãßåò ãéá óùóôÞ ÷ñÞóç ôïõ ðñïãñÜììáôïò" , JOptionPane.PLAIN_MESSAGE);
                    }
                });
        ...
        balmenu=new JMenu("Áñéèìüò balander");
        ...
        edit.add(balmenu);
        edit.addSeparator();
        String[] modes={"Áíèñùðïò-¾ðïëïãéóôçò","Áíèñùðïò-Áíèñùðïò"};
        modemenu=new JMenu("Åßäïò ðáé÷íéäéïý");
        ...
        memorymenu=new JMenu("ÌíÞìç õðïëïãéóôÞ");
    ...
    private class ButtonHandler implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent event)
        {
            if  (event.getSource()==newgame)
            {
                ...
                {
                    String name=JOptionPane.showInputDialog("Ïíüìáóå ôïí ðáßêôç ");
                    player1=new Person(1,name);
                    label1.setText(name);
                    machine=new Machine(2);
                    label2.setText("ÕðïëïãéóôÞò");
                    label3.setText("ÓåéñÜ : "+name);
                    textfield1.setText("");
                    textfield2.setText("");
                }
                else if(mode1[1].isSelected())
                {
                    String name1=JOptionPane.showInputDialog("Ïíüìáóå ôïí ðñþôï ðáßêôç ");
                    String name2=JOptionPane.showInputDialog("Ïíüìáóå ôïí äåýôåñï ðáßêôç ");
                    player1=new Person(1,name1);
                    label1.setText(name1);
                    player2=new Person(2,name2);
                    label2.setText(name2);
                    label3.setText("Óåéñá : "+name1);
                    textfield1.setText("");
                    textfield2.setText("");
                }
                for (int counter=0;counter<bal.length;counter++)
                ...
                if(mode1[0].isSelected())
                {
                    if (order1==false)
                    {
                        if (d==2)
                        {
                            ...
                            {
                                JOptionPane.showMessageDialog(View.this, "Ôåëïò ðáé÷íéäéïý", "ÔÅËÏÓ", JOptionPane.PLAIN_MESSAGE);
                                end=1;
                                order1=false;
                            }
                        }
